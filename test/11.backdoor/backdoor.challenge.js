...
describe("[Challenge] Backdoor", function () {
    ...
    it("Exploit", async function () {
        // let singletonng = this.masterCopy.address;
        // let initializer = ethers.utils.keccak256(
        //     ethers.utils.toUtf8Bytes(
        //         "setup(address[],uint256,address,bytes,address,address,uint256,address)"
        //     )
        // );
        // let saltNonce = 0;
        // let callback = this.walletRegistry.address;
        // await this.walletFactory.createProxyWithCallback(
        //     singletonng,
        //     initializer,
        //     saltNonce,
        //     callback
